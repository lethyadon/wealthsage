      ...
      <main className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <section className="bg-white p-4 rounded shadow space-y-4">
          ...
          <p className="italic text-sm text-gray-600">
            No bank statements? No problem! Manually add expenses here.
          </p>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="flex items-end">
              <button onClick={addExclude} className="w-full bg-gray-700 text-white px-4 py-2 rounded">
                Exclude
              </button>
            </div>
          </div>
          <div className="flex gap-2">
            <button onClick={exportPDF} className="bg-indigo-600 text-white px-4 py-2 rounded">
              Export PDF
            </button>
